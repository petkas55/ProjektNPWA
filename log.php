                        ...
                        <div class="card mb-5" style="background: rgba(255,255,255,0);">
                            <div class="card-body d-flex flex-column align-items-center">
                                ...
                                if (password_verify($_POST['password'], $row['password'])) {
                                    ...
                                    $_SESSION['message'] = '<p id="message">Dobrodošli, ' . $_SESSION['user']['firstname'] . ' ' . $_SESSION['user']['lastname'] . '</p>';
                                ...
                                # Bad username or password
                                    ...
                                    unset($_SESSION['user']);
                                    $_SESSION['message'] = '<p id="message">You entered wrong email or password!</p>';
                                    header("Location: index.php?menu=7");
                                }
                            }
                                print '
